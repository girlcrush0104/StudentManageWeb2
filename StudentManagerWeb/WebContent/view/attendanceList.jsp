	...
	$(function() {	
	    ...
	    $('#dataList').datagrid({ 
	        ...
	        columns: [[  
 		       ...
 		       {field:'type',title:'签到时间',width:200, sortable: false},
	  ...
	  //下拉框通用属性
	    ...
	    $("#add_studentList").combobox({
	  	...
	  	var typeData = [{id:"8:00",text:"8:00"},{id:"10:10",text:"10:10"},{id:"14:00",text:"14:00"},{id:"16:10",text:"16:10"},{id:"18:30",text:"18:30"},{id:"20:15",text:"20:15"}];
...
<body>
	...
	<div id="toolbar">
		...
		<div style="margin-top: 3px;">
			...
			时间：<input id="typeList" class="easyui-textbox" name="typeList" />
			日期：<input id="date" data-options="formatter:myformatter,parser:myparser" class="easyui-datebox" name="date" />
    	...
    	<form id="addForm" method="post">
	    	<table cellpadding="8" >
	    		...
	    		<tr>
	    			...
	    			<td colspan="3">
	    				<input id="add_typeList" style="width: 200px; height: 30px;" class="easyui-textbox" name="type" data-options="required:true, missingMessage:'请选择时间'" />
	    			</td>
	    			<td style="width:80px"></td>
	    		</tr>
	    	</table>
